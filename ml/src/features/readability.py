...
def compute_readability_features(plaintext):
    ...
    ft['RCL'] = 5.88 * num_words / num_sentences - 29.6 * num_characters / num_words - 15.8 # Coleman-Liau Index
    ...
    ft['RSG'] = 3 + math.sqrt(num_polysyllables) # SMOG Index
